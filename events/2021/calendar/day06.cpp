...
void extendedPolymerizationPart1()
{
  ...
  readDocument<std::string>( DAY14_PATH, strInput );
  ...
  const auto[min, max] = std::minmax_element( countById.begin(), countById.end(), [] ( auto& p1, auto&p2 ) { return p1.second < p2.second; } );
